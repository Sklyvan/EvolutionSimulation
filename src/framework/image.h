...
public:
	...
	void resize(unsigned int toWidth, unsigned int toHeight);
	void scale(unsigned int toWidth, unsigned int toHeight);
	...
	//returns a new image with the area from (startx,starty) of size areaWidth,areaHeight
	Image getArea(unsigned int start_x, unsigned int start_y, unsigned int areaWidth, unsigned int areaHeight);
    ...
    void drawRectangle(int x, int y, int w, int h, Color c, bool fill);
    void drawHorizontalLine(int x1, int y1, int x2, int y2, Color C);
    void drawLineBresenham(int x0, int y0, int x1, int y1, Color c);
    void drawCircle(int x0, int y0, int R, Color C, bool fillCircle=true);
    void setPixelsForCirlce(int x, int y, int x0, int y0, Color C, bool fill=true);
};
